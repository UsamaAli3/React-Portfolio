        ...
        >
          <Slider {...settings}>
            ...
            <div className="flex flex-col justify-center items-center h-full  text-center ">
              ...
              <div className="shadow-2xl  w-16 h-16 m-auto p-auto rounded-full  bg-no-repeat bg-cover bg-center bg-[url('https://github.com/UsamaAli3/React-Portfolio/blob/main/public/images/abdul-mateen.jpg?raw=true')] "></div>
