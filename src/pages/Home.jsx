    ...
    <>
      <div className="size-full">
        <div className="flex flex-col-reverse md:flex-row leading-10 p-auto m-auto  h-full justify-center items-center md:h-[75vh] md:w-[85%] pt-28 pb-0 text-skin-color">
          ...
          <div className="size-80 md:w-1/2 md:h-[75vh] md:grow  bg-skin-color flex justify-center md:justify-end items-center">
        ...
        <div className="flex justify-end fixed top-[40vh] right-0 z-10 ">
          <button
            to=""
